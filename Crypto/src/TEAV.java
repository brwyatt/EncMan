...
* </PRE>
*
* @author Translated by Michael Lecuyer from the C Language.
...
public class TEAV
{
	...
	*/
	...
	/**
	 * Added by: Bryan Wyatt
	 * 
	 * Provides a simple way of encryption without the user needing to create a new object.
	 * 
	 * @param plaintext cleartext message to encrypt
	 * @param key 16-byte TEAV key
	 * @return encrypted hex string of the given message
	 */
	public static String encrypt(String plaintext, String key){
		TEAV t=new TEAV(new BigInteger(key, 16).toByteArray());
		plaintext=t.padPlaintext(":"+plaintext+":");
		byte plainSource[] = plaintext.getBytes();
		int enc[] = t.encode(plainSource, plainSource.length);
	 ...
	 * Added by: Bryan Wyatt
	 * 
	 * Provides a simple way of decryption without the user needing to create a new object.
	 * 
	 * @param ciphertext encrypted hex string to decrypt
	 * @param key 16-byte TEAV key
	 * @return cleartext string of the given encrypted message
	 */
	public static String decrypt(String ciphertext, String key){
		TEAV t=new TEAV(new BigInteger(key, 16).toByteArray());
		ciphertext=new String(t.decode(t.hexToBin(ciphertext))).trim();
	...
	*/
	public String binToHex(int enc[]) throws ArrayIndexOutOfBoundsException
	{
		...
		//int tmp[] = new int[2]; //Eclipse claims this is never used
		//int counter = enc.length / 2; //Eclipse claims this is never used
	...
	*/
	...
	/**
	 * Creates a random TEAV key
	 * 
	 * @return random 31 character TEAV key
	 */
