...
public class EncryptionManager{
	...
	public static final String libDownloadURL="http://"+EncryptionManager.baseURL+"DownloadCryptoLibrary.php";
    ...
    public static void OpenID(){
    	currentID=(new OpenID()).getSelectedID();
    	if(currentID==null){
    		JOptionPane.showMessageDialog(null, "The selected ID is null!", "Critical Error", JOptionPane.ERROR_MESSAGE);
    		System.exit(1);
    	}
    }
    public static String currentIDName(){
    	return currentID.getName();
    }
